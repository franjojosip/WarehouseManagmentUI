      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="title" id="modalTarget">Želite li potvrditi ovaj unos?</h5>
          ...
          <Form style={{ margin: 15 }}>
            ...
            <div style={{ padding: 0, float: "right" }}>
              ...
              <Button type="submit" data-dismiss="modal" className="btn btn-success" onClick={(e) => { e.preventDefault(); onSubmit() }}>Potvrdi unos</Button>
            </div>
          </Form>
        </div>
      </div>
